function varargout = ImgDigitizer4k(varargin)
% IMGDIGITIZER4K MATLAB code for ImgDigitizer4k.fig
%      IMGDIGITIZER4K, by itself, creates a new IMGDIGITIZER4K or raises the existing
%      singleton*.
%
%      H = IMGDIGITIZER4K returns the handle to a new IMGDIGITIZER4K or the handle to
%      the existing singleton*.
%
%      IMGDIGITIZER4K('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IMGDIGITIZER4K.M with the given input arguments.
%
%      IMGDIGITIZER4K('Property','Value',...) creates a new IMGDIGITIZER4K or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ImgDigitizer4k_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ImgDigitizer4k_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ImgDigitizer4k

% Last Modified by GUIDE v2.5 17-Nov-2018 11:18:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ImgDigitizer4k_OpeningFcn, ...
                   'gui_OutputFcn',  @ImgDigitizer4k_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ImgDigitizer4k is made visible.
function ImgDigitizer4k_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ImgDigitizer4k (see VARARGIN)

% Choose default command line output for ImgDigitizer4k
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes ImgDigitizer4k wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ImgDigitizer4k_OutputFcn(hObject, eventdata, handles) 
